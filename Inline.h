 ...
 *
 */
INLINE BOOL Bus_DoyMatePronto(SINT32 s32Eval)
{
	return(s32Eval >= +INFINITO - 30000);
}
INLINE BOOL Bus_ReciboMatePronto(SINT32 s32Eval)
{
	return(s32Eval <= -INFINITO + 30000);
}
INLINE void Bus_ActualizarPV(TJugada jug, SINT32 s32Ply)
{
...
// Get
//
INLINE UINT32 Hash_GetProf(TNodoHash * phs)
{
	return((UINT32)phs->u8Prof);
}
INLINE BOOL Hash_GetIntentarNull(TNodoHash * phs)
{
	assert((BOOL)(phs->u8Flags >> 4) == TRUE || (BOOL)(phs->u8Flags >> 4) == FALSE);
	return((BOOL)(phs->u8Flags >> 4));
}
INLINE BOOL Hash_GetEsExacto(TNodoHash * phs)
{
	return((BOOL)((phs->u8Flags & (UINT8)BOUND_EXACTO) >> 1));
}
INLINE BOOL Hash_GetEsUBound(TNodoHash * phs)
{
	return((BOOL)((phs->u8Flags & (UINT8)BOUND_UPPER) >> 2));
}
INLINE BOOL Hash_GetEsLBound(TNodoHash * phs)
{
	return((BOOL)((phs->u8Flags & (UINT8)BOUND_LOWER) >> 3));
}
INLINE int Hash_GetBound(TNodoHash* phs)
{
	return(phs->u8Flags & (BOUND_EXACTO | BOUND_UPPER | BOUND_LOWER));
}
INLINE UINT32 Hash_GetTurno(TNodoHash * phs)
{
	return((UINT32)(phs->u8Flags & (UINT8)0x01));
}
INLINE UINT32 Hash_GetMaterial(TNodoHash * phs)
{
	return((UINT32)(phs->u16Material));
}
INLINE int EvalToTT(int eval, int ply)
{
...
INLINE int EvalFromTT(int eval, int ply)
{
	if (Bus_DoyMatePronto(eval))
		eval -= ply;
	else if (Bus_ReciboMatePronto(eval))
...
INLINE void Hash_SetMaterial(TNodoHash * phs, UINT32 u32Material)
{
...
// Get (000T JNRC)
//
INLINE UINT32 Pos_GetTurno(TPosicion * pPos)
{
	return((UINT32)pPos->u8Turno);
}
INLINE UINT32 Pos_GetJaqueado(TPosicion * pPos)
{
	return((UINT32)pPos->u8Jaqueado);
}
INLINE UINT32 Pos_GetIntentarNull(TPosicion * pPos)
{
	return((UINT32)pPos->u8IntentarNull);
}
INLINE UINT32 Pos_GetCaptura(TPosicion * pPos)
{
	return((UINT32)(pPos->s32EvalMaterial != (pPos-1)->s32EvalMaterial));
}
INLINE UINT32 Pos_GetRecaptura(TPosicion * pPos)
{
	return((UINT32)(Pos_GetCaptura(pPos) && Pos_GetCaptura(pPos - 1)));
}
// Enroques
INLINE UINT32 Pos_GetPuedeCortoB(TPosicion * pPos)
{
	return((pPos->u8Enroques)&1);
}
INLINE UINT32 Pos_GetPuedeLargoB(TPosicion * pPos)
{
	return((pPos->u8Enroques)&2);
}
INLINE UINT32 Pos_GetPuedeCortoN(TPosicion * pPos)
{
	return((pPos->u8Enroques)&4);
}
INLINE UINT32 Pos_GetPuedeLargoN(TPosicion * pPos)
{
...
INLINE UINT32 Pos_GetFasePartida(TPosicion * pPos)
{
	UINT32 u32Patron = 0;
...
// Set
//
INLINE void Pos_SetTurnoB(TPosicion * pPos)
{
	pPos->u8Turno = BLANCAS;
	assert(Pos_GetTurno(pPos) == BLANCAS);
}
INLINE void Pos_SetTurnoN(TPosicion * pPos)
{
	pPos->u8Turno = NEGRAS;
	assert(Pos_GetTurno(pPos) == NEGRAS);
}
INLINE void Pos_CambiarTurno(TPosicion * pPos)
{
	pPos->u8Turno = (UINT8)!pPos->u8Turno;
}
INLINE void Pos_SetJaqueado(TPosicion * pPos)
{
	pPos->u8Jaqueado = (UINT8)1;
	assert(Pos_GetJaqueado(pPos));
}
INLINE void Pos_SetNoJaqueado(TPosicion * pPos)
{
	pPos->u8Jaqueado = (UINT8)0;
	assert(!Pos_GetJaqueado(pPos));
}
INLINE void Pos_SetIntentarNull(TPosicion * pPos)
{
	pPos->u8IntentarNull = (UINT8)1;
	assert(Pos_GetIntentarNull(pPos));
}
INLINE void Pos_SetNoIntentarNull(TPosicion * pPos)
{
	pPos->u8IntentarNull = (UINT8)0;
	assert(!Pos_GetIntentarNull(pPos));
}
// Enroques
INLINE void Pos_SetCortoB(TPosicion * pPos)
{
	pPos->u8Enroques |= (UINT8)1;
	assert(Pos_GetPuedeCortoB(pPos));
}
INLINE void Pos_SetLargoB(TPosicion * pPos)
{
	pPos->u8Enroques |= (UINT8)2;
	assert(Pos_GetPuedeLargoB(pPos));
}
INLINE void Pos_SetCortoN(TPosicion * pPos)
{
	pPos->u8Enroques |= (UINT8)4;
	assert(Pos_GetPuedeCortoN(pPos));
}
INLINE void Pos_SetLargoN(TPosicion * pPos)
{
	pPos->u8Enroques |= (UINT8)8;
	assert(Pos_GetPuedeLargoN(pPos));
}
INLINE void Pos_SetNoEnroquesB(TPosicion * pPos)
{
	pPos->u8Enroques &= (UINT8)0xFC; // 1111 1100
	assert(!Pos_GetPuedeCortoB(pPos));
	assert(!Pos_GetPuedeLargoB(pPos));
}
INLINE void Pos_SetNoEnroqueCortoB(TPosicion * pPos)
{
	pPos->u8Enroques &= (UINT8)0xFE; // 1111 1110
	assert(!Pos_GetPuedeCortoB(pPos));
}
INLINE void Pos_SetNoEnroqueLargoB(TPosicion * pPos)
{
	pPos->u8Enroques &= (UINT8)0xFD; // 1111 1101
	assert(!Pos_GetPuedeLargoB(pPos));
}
INLINE void Pos_SetNoEnroquesN(TPosicion * pPos)
{
	pPos->u8Enroques &= (UINT8)0xF3; // 1111 0011
	assert(!Pos_GetPuedeCortoN(pPos));
	assert(!Pos_GetPuedeLargoN(pPos));
}
INLINE void Pos_SetNoEnroqueCortoN(TPosicion * pPos)
{
	pPos->u8Enroques &= (UINT8)0xFB; // 1111 1011
	assert(!Pos_GetPuedeCortoN(pPos));
}
INLINE void Pos_SetNoEnroqueLargoN(TPosicion * pPos)
{
	pPos->u8Enroques &= (UINT8)0xF7; // 1111 0111
	assert(!Pos_GetPuedeLargoN(pPos));
}
INLINE void Pos_SetEval(TPosicion* pPos, SINT32 s32Eval)
{
	ComputarBB(pPos);
...
//
INLINE SINT32 Jug_GetVal(TJugada jug)
{
	return(jug.s32Val);
}
INLINE UINT32 Jug_GetDesde(TJugada jug)
{
	assert(((jug.u32Mov >> 6) & 0x003F) < 64);
	return((jug.u32Mov >> 6) & 0x003F);
}
INLINE UINT32 Jug_GetHasta(TJugada jug)
{
	assert((jug.u32Mov & 0x003F) < 64);
	return(jug.u32Mov & 0x003F);
}
INLINE UINT32 Jug_GetPromo(TJugada jug)
{
	return(jug.u32Mov >> 12);
}
INLINE UINT32 Jug_GetMov(TJugada jug)
{
	assert(Jug_GetDesde(jug) < 64 && Jug_GetHasta(jug) < 64 && Jug_GetPromo(jug) < 15);
	return(jug.u32Mov);
}
INLINE BOOL Jug_GetEsNula(TJugada jug)
{
	assert(Jug_GetDesde(jug) < 64 && Jug_GetHasta(jug) < 64 && Jug_GetPromo(jug) < 15);
	return(jug.u32Mov == 0);
}
INLINE UINT32 Jug_GetDesdeMov(UINT32 u32Mov)
{
	assert(((u32Mov >> 6) & 0x003F) < 64);
	return((u32Mov >> 6) & 0x003F);
}
INLINE UINT32 Jug_GetHastaMov(UINT32 u32Mov)
{
...
// Set
//
INLINE void Jug_SetVal(TJugada * pJug, SINT32 s32Val)
{
	pJug->s32Val = s32Val;
	assert(Jug_GetVal(*pJug) == s32Val);
}
INLINE void Jug_SetMov(TJugada * pJug, UINT32 u32Mov)
{
	pJug->u32Mov = u32Mov;
	assert(Jug_GetMov(*pJug) == u32Mov);
}
INLINE void Jug_SetDesde(TJugada * pJug,UINT32 u32Casilla)
{
...
INLINE void Jug_SetHasta(TJugada * pJug,UINT32 u32Casilla)
{
	assert(!(u32Casilla & 0xFFC0));
	pJug->u32Mov &= 0xFFC0;
...
INLINE void Jug_SetPromo(TJugada * pJug,UINT32 u32Pieza)
{
	pJug->u32Mov &= 0x0FFF;
	pJug->u32Mov |= (u32Pieza << 12);
	assert(Jug_GetPromo(*pJug) == u32Pieza);
}
INLINE void Jug_SetMovEvalCero(TJugada * pJug,UINT32 u32Desde,UINT32 u32Hasta,UINT32 u32Promo)
{
...
INLINE void Jug_SetMovConEval(TJugada * pJug,UINT32 u32Desde,UINT32 u32Hasta,UINT32 u32Promo,SINT32 s32Eval)
{
	assert(!(u32Desde & 0xFFC0));
	assert(!(u32Hasta & 0xFFC0));
	pJug->u32Mov = ((u32Desde << 6) | u32Hasta | (u32Promo << 12));
...
INLINE void Jug_SetMovConHistoria(TJugada* pJug, UINT32 u32Desde, UINT32 u32Hasta, UINT32 u32Promo)
{
	assert(!(u32Desde & 0xFFC0));
	assert(!(u32Hasta & 0xFFC0));
	pJug->u32Mov = ((u32Desde << 6) | u32Hasta | (u32Promo << 12));
...
INLINE void Jug_SetNula(TJugada* pJug)
{
	pJug->u32Mov = 0;
	pJug->s32Val = 0;
}
...
// Get
//
INLINE UINT32 Pie_GetEsPasadoB(TPosicion * pPos,UINT32 u32Casilla)
{
	return((au64AreaPasadoB[u32Casilla] & pPos->u64PeonesN) == BB_TABLEROVACIO);
}
INLINE UINT32 Pie_GetEsPasadoN(TPosicion * pPos,UINT32 u32Casilla)
{
 ...
 *
 */
INLINE UINT32 Tab_GetColumna(UINT32 u32Casilla)
{
	assert(u32Casilla < 64);
	return(u32Casilla & 7);
}
INLINE UINT32 Tab_GetFila(UINT32 u32Casilla)
{
	assert(u32Casilla < 64);
	return(u32Casilla >> 3);
}
INLINE UINT32 Tab_GetDistancia(UINT32 u32Cas1, UINT32 u32Cas2)
{
	assert(u32Cas1 < 64);
	assert(u32Cas2 < 64);
...
// Ataques verticales
//
INLINE UINT64 AtaquesArriba(UINT64 u64Pieza, UINT64 u64Vacias)
{
...
INLINE UINT64 RellenarArriba(UINT64 u64)
{
	u64 |= (u64 << 8);
	u64 |= (u64 << 16);
	u64 |= (u64 << 32);
...
INLINE UINT64 AtaquesAbajo(UINT64 u64Pieza, UINT64 u64Vacias)
{
	u64Pieza |= (u64Pieza >>  8) & u64Vacias;
	u64Vacias &= (u64Vacias >>  8);
	u64Pieza |= (u64Pieza >> 16) & u64Vacias;
...
INLINE UINT64 RellenarAbajo(UINT64 u64)
{
	u64 |= (u64 >> 8);
	u64 |= (u64 >> 16);
	u64 |= (u64 >> 32);
...
//
INLINE UINT64 AtaquesDerecha(UINT64 u64Pieza, UINT64 u64Vacias)
{
...
INLINE UINT64 AtaquesIzquierda(UINT64 u64Pieza, UINT64 u64Vacias)
{
...
// Ataques Torre
//
INLINE UINT64 AtaquesTorre(UINT64 u64Pieza, UINT64 u64Vacias)
{
...
// Ataques peón
//
INLINE UINT64 AtaquesPeonB_old(UINT64 u64Pieza)
{
	UINT64 u64 = u64Pieza;
	u64Pieza ^= u64;
...
INLINE UINT64 AtaquesPeonB(UINT64 u64Pieza)
{
#if defined(_DEBUG)
...
INLINE UINT64 AtaquesPeonN(UINT64 u64Pieza)
{
	UINT64 u64 = u64Pieza;
	u64Pieza ^= u64;
...
// Ataques caballo
//
INLINE UINT64 AtaquesCaballo(UINT64 u64Pieza)
{
	UINT64 u64 = u64Pieza;
	u64Pieza ^= u64;
...
// Ataques rey
//
INLINE UINT64 AtaquesRey(UINT64 u64Pieza)
{
	UINT64 u64 = u64Pieza;
...
// Ataques diagonales
//
INLINE UINT64 AtaquesAbajoDcha(UINT64 u64Pieza, UINT64 u64Vacias)
{
	u64Vacias &= BB_SINCOLIZDA;
...
INLINE UINT64 AtaquesArribaDcha(UINT64 u64Pieza, UINT64 u64Vacias)
{
	u64Vacias &= BB_SINCOLIZDA;
...
INLINE UINT64 AtaquesAbajoIzda(UINT64 u64Pieza, UINT64 u64Vacias)
{
	u64Vacias &= BB_SINCOLDCHA;
	u64Pieza |= (u64Pieza >>  7) & u64Vacias;
	u64Vacias &= (u64Vacias >>  7);
...
INLINE UINT64 AtaquesArribaIzda(UINT64 u64Pieza, UINT64 u64Vacias)
{
	u64Vacias &= BB_SINCOLDCHA;
	u64Pieza |= (u64Pieza <<  9) & u64Vacias;
	u64Vacias &= (u64Vacias <<  9);
...
// Ataques alfil
//
INLINE UINT64 AtaquesAlfil(UINT64 u64Pieza, UINT64 u64Vacias)
{
