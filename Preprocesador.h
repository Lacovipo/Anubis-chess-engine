...
//			3.03a:
//				PESO_FP = 10000, 5000
//				(profdif, beta, beta, beta, alfa, alfa, alfa)
//				10, 400, 300, 48, 450, 350, 4
//
//			3.03b:
//				PESO_FP = 1000
//				(profdif, beta, beta, beta, alfa, alfa, alfa)
//				10, 400, 0, 1, 240, 225, 47
//
//			3.03c:
//				PESO_FP = 500
//				(profdif, beta, beta, beta, alfa, alfa, alfa)
//				10, 185, 0, 13, 390, 30, 48
//
//			3.03d:
//				PESO_FP = 100
//				(profdif, beta, beta, beta, alfa, alfa, alfa)
...
//				10, 55, 0, 0, 25, 0, 47
// 
//			Me quedo con la 3.03c, que es la que mejor resultados obtiene
// 
/////////////////////////////////////////////////
...
#if defined(VERS_303)
	#define VERSION "Anubis v3.03c"
	#define NOMBRE_LOG "An_3.03_"


											//	1.00	1.01	1.02	2.00	2.01	2.02	2.03	2.10	3.00	3.01	3.02	3.03
											//----------------------------------------------------------------------------------------------
